...
import { BottomNavigation, BottomNavigationItem, Paper } from '@copart/core-components'
import './style.scss'
      ...
      <BottomNavigation className="bottomnav background">
        <div className="notes">
          <div className="notesContainer">
            <span>
              <i style={{ fontSize: '24px' }} className="material-icons md-light">
                insert_drive_file
              </i>
            </span>
            <span className="notesText">Notes</span>
            <span className="notesText" style={{ right: '-10px' }}>
              F6
            </span>
          </div>
        </div>
