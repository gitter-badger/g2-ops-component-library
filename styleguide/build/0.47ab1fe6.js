webpackJsonp([0], {
  1765: function(e, t, n) {
          ...
          d(Editor, [
            ...
            },
            {
              ...
              value: function render() {
                ...
                return i.a.createElement(c.UnControlled, { value: e, onChange: this.handleChange, options: t })
              },
            },
          ]),
          Editor
    ...
    ;(h.propTypes = { code: a.a.string.isRequired, onChange: a.a.func.isRequired }),
  ...
  1766: function(e, t, n) {
    ...
    ;(r = function() {
      ...
      function joinClasses(e, t) {
        for (var n = e.split(' '), r = 0; r < n.length; r++) n[r] && !classTest(n[r]).test(t) && (t += ' ' + n[r])
        return t
      }
      ...
      function createObj(e, t) {
        var n
        return (
          Object.create ? (n = Object.create(e)) : ((nothing.prototype = e), (n = new nothing())), t && copyObj(t, n), n
        )
      }
      var W = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/
      function isWordCharBasic(e) {
        return /\w/.test(e) || (e > '' && (e.toUpperCase() != e.toLowerCase() || W.test(e)))
      }
      function isWordChar(e, t) {
        return t ? !!(t.source.indexOf('\\w') > -1 && isWordCharBasic(e)) || t.test(e) : isWordCharBasic(e)
      }
      function isEmpty(e) {
      ...
      function lineNo(e) {
        ...
        for (var t = e.parent, n = indexOf(t.lines, e), r = t.parent; r; t = r, r = r.parent)
            ...
            if (e)
              for (var i = 0; i < e.length; ++i) {
                ...
                if (
                  ...
                  ;(r || (r = [])).push(new MarkedSpan(a, s ? null : o.from - t, null == o.to ? null : o.to - t))
                }
              }
            return r
          })(r, o, a),
        ...
        if (l)
          for (var f = 0; f < l.length; ++f) {
            ...
            if ((null != g.to && (g.to += u), null == g.from))
              getMarkedSpanFor(s, g.marker) || ((g.from = u), c && (s || (s = [])).push(g))
        ...
        if (!c) {
          ...
          if (y > 0 && s)
            for (var b = 0; b < s.length; ++b)
              null == s[b].to && (v || (v = [])).push(new MarkedSpan(s[b].marker, null, null))
        ...
        if (a)
          for (var s = 0; s < a.length; ++s) {
            ...
            if (l.marker.collapsed) {
              ...
              if (
                !((u >= 0 && d <= 0) || (u <= 0 && d >= 0)) &&
                ((u <= 0 && (l.marker.inclusiveRight && i.inclusiveLeft ? cmp(c.to, n) >= 0 : cmp(c.to, n) > 0)) ||
                  (u >= 0 && (l.marker.inclusiveRight && i.inclusiveLeft ? cmp(c.from, r) <= 0 : cmp(c.from, r) < 0)))
              )
                return !0
            }
          }
        ...
        if (n)
          for (var r = void 0, i = 0; i < n.length; ++i)
            if ((r = n[i]).marker.collapsed) {
              ...
              if (!r.marker.widgetNode && 0 == r.from && r.marker.inclusiveLeft && lineIsHiddenInner(e, t, r)) return !0
            }
      }
      function lineIsHiddenInner(e, t, n) {
        if (null == n.to) {
          var r = n.marker.find(1, !0)
          return lineIsHiddenInner(e, r.line, getMarkedSpanFor(r.line.markedSpans, n.marker))
        }
      ...
      function heightAtLine(e) {
        for (var t = 0, n = (e = visualLine(e)).parent, r = 0; r < n.lines.length; ++r) {
          var i = n.lines[r]
          if (i == e) break
          t += i.height
        }
      ...
      function getBidiPartAt(e, t, n) {
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          o.to == t && (o.from != o.to && 'before' == n ? (r = i) : (B = i)),
            o.from == t && (o.from != o.to && 'before' != n ? (r = i) : (B = i))
        }
        return null != r ? r : B
      }
      var z = (function() {
        ...
        return function(s, l) {
          ...
          for (var v = 0, y = c; v < d; ++v) {
            var b = p[v]
            '1' == b && 'r' == y ? (p[v] = 'n') : i.test(b) && ((y = b), 'r' == b && (p[v] = 'R'))
          }
          ...
          for (var S = 0; S < d; ++S) {
            ...
            if (',' == k) p[S] = 'N'
              ...
              var L = void 0
              for (L = S + 1; L < d && '%' == p[L]; ++L);
              for (var M = (S && '!' == p[S - 1]) || (L < d && '1' == p[L]) ? '1' : 'N', T = S; T < L; ++T) p[T] = M
              S = L - 1
            }
          }
          ...
          for (var N = 0; N < d; ++N)
            if (r.test(p[N])) {
              ...
              for (
                var H = 'L' == (N ? p[N - 1] : c), W = H == ('L' == (D < d ? p[D] : c)) ? (H ? 'L' : 'R') : c, E = N;
                E < D;
                ++E
              )
                p[E] = W
          ...
          return (
            'ltr' == l &&
              (1 == F[0].level &&
                (I = s.match(/^\s+/)) &&
                ((F[0].from = I[0].length), F.unshift(new BidiSpan(0, 0, I[0].length))),
              1 == lst(F).level &&
                (I = s.match(/\s+$/)) &&
                ((lst(F).to -= I[0].length), F.push(new BidiSpan(0, d - I[0].length, d)))),
            'rtl' == l ? F.reverse() : F
          )
        }
      })()
      ...
      function zeroWidthElement(e) {
        if (null == U) {
          ...
          removeChildrenAndAdd(e, elt('span', [t, document.createTextNode('x')])),
            0 != e.firstChild.offsetHeight && (U = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(a && s < 8))
        }
        var n = U ? elt('span', '​') : elt('span', ' ', null, 'display: inline-block; width: 1px; margin-right: -1px')
      ...
      function hasBadBidiRects(e) {
        ...
        return removeChildren(e), !(!n || n.left == n.right) && (j = r.right - n.right < 3)
      }
      var K,
        _ =
          3 != '\n\nb'.split(/\n/).length
        ...
        q = 'oncopy' in (K = elt('div')) || (K.setAttribute('oncopy', 'return;'), 'function' == typeof K.oncopy),
        X = null
      var Y = {},
        Z = {}
      ...
      function getLineStyles(e, t, n) {
        if (!t.styles || t.styles[0] != e.state.modeGen) {
          var r = getContextBefore(e, lineNo(t)),
            i = t.text.length > e.options.maxHighlightLength && copyState(e.doc.mode, r.state),
      ...
      function getContextBefore(e, t, n) {
        ...
        var o = (function findStartLine(e, t, n) {
            for (var r, i, o = e.doc, a = n ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > a; --s) {
              ...
              var l = getLine(o, s - 1),
                c = l.stateAfter
              if (c && (!n || s + (c instanceof ee ? c.lookAhead : 0) <= o.modeFrontier)) return s
      ...
      function processLine(e, t, n, r) {
        ...
        for (o.start = o.pos = r || 0, '' == t && callBlankLine(i, n.state); !o.eol(); )
      ...
      function takeToken(e, t, n, r) {
        ...
        for (r && (o = []); (r || u.pos < t.ch) && !u.eol(); )
          (u.start = u.pos), (i = readToken(s, u, c.state)), r && o.push(new ne(u, i, copyState(a.mode, c.state)))
      ...
      function runMode(e, t, n, r, i, o, a) {
        ...
        for ('' == t && extractLineClasses(callBlankLine(n, r.state), o); !d.eol(); ) {
          if (
            (d.pos > e.options.maxHighlightLength
              ? ((s = !1), a && processLine(e, t, r, d.pos), (d.pos = t.length), (l = null))
      ...
      function buildLineContent(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
          ...
          ;(r.pos = 0),
            ...
            (r.map = []),
            insertLineContent(o, r, getLineStyles(e, o, t != e.display.externalMeasured && lineNo(o))),
            o.styleClasses &&
              (o.styleClasses.bgClass && (r.bgClass = joinClasses(o.styleClasses.bgClass, r.bgClass || '')),
              o.styleClasses.textClass && (r.textClass = joinClasses(o.styleClasses.textClass, r.textClass || ''))),
            0 == r.map.length && r.map.push(0, 0, r.content.appendChild(zeroWidthElement(e.display.measure))),
            0 == i
        ...
        return (
          ...
          r.pre.className && (r.textClass = joinClasses(r.pre.className, r.textClass || '')),
          r
        )
      }
        ...
        if (t) {
          ...
          if (d.test(t)) {
            ...
            for (var h = 0; ; ) {
              ...
              if ('\t' == f[0]) {
                var y = e.cm.options.tabSize,
                  b = y - e.col % y
                ;(v = c.appendChild(elt('span', spaceStr(b), 'cm-tab'))).setAttribute('role', 'presentation'),
                  v.setAttribute('cm-text', '\t'),
                  (e.col += b)
              } else
                '\r' == f[0] || '\n' == f[0]
                  ? ((v = c.appendChild(elt('span', '\r' == f[0] ? '␍' : '␤', 'cm-invalidchar'))).setAttribute(
                      'cm-text',
                      f[0],
                    ),
                    (e.col += 1))
                  : ((v = e.cm.options.specialCharPlaceholder(f[0])).setAttribute('cm-text', f[0]),
            ...
            (e.col += t.length),
              ...
              a && s < 9 && (p = !0),
              (e.pos += t.length)
          if (((e.trailingSpace = 32 == u.charCodeAt(t.length - 1)), n || r || i || p || l)) {
            var x = n || ''
            r && (x += r), i && (x += i)
      ...
      function insertLineContent(e, t, n) {
        var r = e.markedSpans,
          ...
          o = 0
        if (r)
          for (var a, s, l, c, u, d, p, h = i.length, f = 0, g = 1, m = '', v = 0; ; ) {
            if (v == f) {
              ...
              for (var y = [], b = void 0, x = 0; x < r.length; ++x) {
                ...
                'bookmark' == w.type && C.from == f && w.widgetNode
                  ? y.push(w)
                  : C.from <= f && (null == C.to || C.to > f || (w.collapsed && C.to == f && C.from == f))
                    ? (null != C.to && C.to != f && v > C.to && ((v = C.to), (c = '')),
                      ...
                      w.title && !d && (d = w.title),
                      w.collapsed && (!p || compareCollapsedMarkers(p.marker, w) < 0) && (p = C))
                    : C.from > f && v > C.from && (v = C.from)
              }
              if (b) for (var S = 0; S < b.length; S += 2) b[S + 1] == v && (c += ' ' + b[S])
              if (!p || p.from == f) for (var k = 0; k < y.length; ++k) buildCollapsedSpan(t, 0, y[k])
              if (p && (p.from || 0) == f) {
                if ((buildCollapsedSpan(t, (null == p.to ? h + 1 : p.to) - f, p.marker, null == p.from), null == p.to))
                  return
                p.to == f && (p = !1)
              }
            }
            ...
            for (var L = Math.min(h, v); ; ) {
              ...
              ;(m = i.slice(o, (o = n[g++]))), (a = interpretTokenStyle(n[g++], t.cm.options))
            }
          }
        else
          for (var O = 1; O < n.length; O += 2)
            t.addToken(t, i.slice(o, (o = n[O])), interpretTokenStyle(n[O + 1], t.cm.options))
      }
      ...
      function signalLater(e, t) {
        ...
        if (n.length) {
          ...
          ae ? (r = ae.delayedCallbacks) : se ? (r = se) : ((r = se = []), setTimeout(fireOrphanDelayed, 0))
          for (
            var o = function(e) {
                r.push(function() {
      ...
      function updateLineText(e, t) {
        ...
        t.text == t.node && (t.node = r.pre),
          ...
          r.bgClass != t.bgClass || r.textClass != t.textClass
            ? ((t.bgClass = r.bgClass), (t.textClass = r.textClass), updateLineClasses(e, t))
      ...
      function insertLineWidgets(e, t, n) {
        if ((insertLineWidgetsFor(e, t.line, t, n, !0), t.rest))
          for (var r = 0; r < t.rest.length; r++) insertLineWidgetsFor(e, t.rest[r], t, n, !1)
      }
      function insertLineWidgetsFor(e, t, n, r, i) {
        if (t.widgets)
          for (var o = ensureLineWrapped(n), a = 0, s = t.widgets; a < s.length; ++a) {
            var l = s[a],
      ...
      function prepareMeasureForLine(e, t) {
        ...
        r && !r.text
          ? (r = null)
          : r && r.changes && (updateLineForChanges(e, r, n, getDimensions(e)), (e.curOp.forceUpdate = !0)),
          r ||
            (r = (function updateExternalMeasurement(e, t) {
              ...
              return (r.text = i.pre), removeChildrenAndAdd(e.display.lineMeasure, i.pre), r
            })(e, t))
          ...
          t.cache.hasOwnProperty(l)
            ...
            : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
              ...
              (o = (function measureCharInner(e, t, n, r) {
                ...
                if (3 == l.nodeType) {
                  for (var p = 0; p < 4; p++) {
                    for (; c && isExtendingChar(t.line.text.charAt(o.coverStart + c)); ) --c
                    for (; o.coverStart + u < o.coverEnd && isExtendingChar(t.line.text.charAt(o.coverStart + u)); ) ++u
                    if (
                      (i =
                ...
                if (a && s < 9 && !c && (!i || (!i.left && !i.right))) {
                  ...
                  i = f ? { left: f.left, right: f.left + charWidth(e.display), top: f.top, bottom: f.bottom } : ce
                }
                for (
      ...
      function widgetTopHeight(e) {
        var t = 0
        if (e.widgets)
          for (var n = 0; n < e.widgets.length; ++n) e.widgets[n].above && (t += widgetHeight(e.widgets[n]))
        return t
      }
      function intoCoordSystem(e, t, n, r, i) {
        ...
        if (('local' == r ? (a += paddingTop(e.display)) : (a -= e.display.viewOffset), 'page' == r || 'window' == r)) {
      ...
      function charCoords(e, t, n, r, i) {
        return r || (r = getLine(e.doc, t.line)), intoCoordSystem(e, r, measureChar(e, r, t.ch, i), n)
      }
      function cursorCoords(e, t, n, r, i, o) {
        function get(t, a) {
          var s = measureCharPrepared(e, i, t, a ? 'right' : 'left', o)
          return a ? (s.left = s.right) : (s.right = s.left), intoCoordSystem(e, r, s, n)
        }
        ;(r = r || getLine(e.doc, t.line)), i || (i = prepareMeasureForLine(e, r))
        var a = getOrder(r, e.doc.direction),
          s = t.ch,
          l = t.sticky
        if ((s >= r.text.length ? ((s = r.text.length), (l = 'before')) : s <= 0 && ((s = 0), (l = 'after')), !a))
      ...
      function coordsChar(e, t, n) {
        var r = e.doc
        if ((n += e.display.viewOffset) < 0) return PosWithInfo(r.first, 0, null, !0, -1)
        var i = lineAtHeight(r, n),
          o = r.first + r.size - 1
        if (i > o) return PosWithInfo(r.first + r.size - 1, getLine(r, o).text.length, null, !0, 1)
        t < 0 && (t = 0)
      ...
      function wrappedLineExtentChar(e, t, n, r) {
        return (
          ...
          wrappedLineExtent(e, t, n, intoCoordSystem(e, t, measureCharPrepared(e, n, r), 'line').top)
        )
      }
      ...
      function coordsCharInner(e, t, n, r, i) {
          ...
          var d = (e.options.lineWrapping
            ? function coordsBidiPartWrapped(e, t, n, r, i, o, a) {
                ...
                for (var u = null, d = null, p = 0; p < i.length; p++) {
                  ...
                  if (!(h.from >= c || h.to <= l)) {
                    var f = 1 != h.level,
                      g = measureCharPrepared(e, r, f ? Math.min(c, h.to) - 1 : Math.max(l, h.from)).right,
                      m = g < o ? o - g + 1e9 : g - o
                    ;(!u || d > m) && ((u = h), (d = m))
                  }
                }
            ...
            : function coordsBidiPart(e, t, n, r, i, o, a) {
                var s = findFirst(
                    function(s) {
                      var l = i[s],
                        c = 1 != l.level
                      return boxIsAfter(
                        cursorCoords(e, Pos(n, c ? l.to : l.from, c ? 'before' : 'after'), 'line', t, r),
                        o,
                        a,
                        !0,
                      )
                ...
                if (s > 0) {
                  var c = 1 != l.level,
                    u = cursorCoords(e, Pos(n, c ? l.from : l.to, c ? 'after' : 'before'), 'line', t, r)
          ...
          m = findFirst(
            function(t) {
              ...
              return (
                (n.top += a),
                (n.bottom += a),
                !!boxIsAfter(n, r, i, !1) && (n.top <= i && n.left <= r && ((f = t), (g = n)), !0)
              )
            },
            s,
            l,
        ...
        if (g) {
          var y = r - g.left < g.right - r,
            b = y == c
          ;(m = f + (b ? 0 : 1)), (h = b ? 'after' : 'before'), (p = y ? g.left : g.right)
        } else {
          c || (m != l && m != s) || m++,
            (h =
              0 == m
                ...
                : m == t.text.length
                  ? 'before'
                  : measureCharPrepared(e, o, m - (c ? 1 : 0)).bottom + a <= i == c
                    ? 'after'
                    : 'before')
      ...
      function estimateHeight(e) {
        var t = textHeight(e.display),
          ...
          r = n && Math.max(5, e.display.scroller.clientWidth / charWidth(e.display) - 3)
        return function(i) {
      ...
      function posFromMouse(e, t, n, r) {
        ...
        if (r && 1 == c.xRel && (l = getLine(e.doc, c.line).text).length == c.ch) {
          ...
          c = Pos(c.line, Math.max(0, Math.round((o - paddingH(e.display).left) / charWidth(e.display)) - u))
        }
        return c
      }
        ...
        for (
          ...
          if (t || a != n.sel.primIndex) {
            ...
            if (!(s.from().line >= e.display.viewTo || s.to().line < e.display.viewFrom)) {
              var l = s.empty()
              ;(l || e.options.showCursorWhenSelecting) && drawSelectionCursor(e, s.head, i),
      ...
      function drawSelectionCursor(e, t, n) {
        var r = cursorCoords(e, t, 'div', null, null, !e.options.singleCursorHeightPerLine),
        ...
        if (
          ...
          var o = n.appendChild(elt('div', ' ', 'CodeMirror-cursor CodeMirror-secondarycursor'))
          ;(o.style.display = ''),
      ...
      function drawSelectionRange(e, t, n) {
        ...
        function drawForLine(t, n, r) {
          ...
          function wrapX(t, n, r) {
            ...
            return coords('after' == r ? i.begin : i.end - (/\s/.test(u.text.charAt(i.end - 1)) ? 2 : 1), o)[o]
          }
      ...
      function onBlur(e, t) {
        e.state.delayingBlurEvent ||
          (e.state.focused &&
            (signal(e, 'blur', e, t), (e.state.focused = !1), L(e.display.wrapper, 'CodeMirror-focused')),
      ...
      function updateHeightsInViewport(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
          ...
          if (!i.hidden) {
            ...
            if (
              (o < 2 && (o = textHeight(t)),
              (u > 0.005 || u < -0.005) && (updateLineHeight(i.line, o), updateWidgetHeight(i.line), i.rest))
            )
              for (var d = 0; d < i.rest.length; d++) updateWidgetHeight(i.rest[d])
          }
        }
      }
      ...
      function visibleLines(e, t, n) {
        ...
        if (n && n.ensure) {
          var s = n.ensure.from.line,
            l = n.ensure.to.line
          s < o
            ? ((o = s), (a = lineAtHeight(t, heightAtLine(getLine(t, s)) + e.wrapper.clientHeight)))
            : Math.min(l, t.lastLine()) >= a &&
              ((o = lineAtHeight(t, heightAtLine(getLine(t, l)) - e.wrapper.clientHeight)), (a = l))
        }
      ...
      function maybeUpdateLineNumberWidth(e) {
        ...
        if (n.length != r.lineNumChars) {
          var i = r.measure.appendChild(elt('div', [elt('div', n)], 'CodeMirror-linenumber CodeMirror-gutter-elt')),
      ...
      function resolveScrollToPos(e) {
        ...
        t &&
          ...
          scrollToCoordsRange(e, estimateCoords(e, t.from), estimateCoords(e, t.to), t.margin))
      }
      ...
      var ue = function(e, t, n) {
        this.cm = n
        var r = (this.vert = elt('div', [elt('div', null, null, 'min-width: 1px')], 'CodeMirror-vscrollbar')),
          i = (this.horiz = elt(
            'div',
      ...
      function updateScrollbars(e, t) {
        ...
        for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++)
          n != e.display.barWidth && e.options.lineWrapping && updateHeightsInViewport(e),
      ...
      function startOperation(e) {
        ;(e.curOp = {
          ...
          (function pushOperation(e) {
            ae ? ae.ops.push(e) : (e.ownsGroup = ae = { ops: [e], delayedCallbacks: [] })
          })(e.curOp)
      }
        ...
        !(function finishOperation(e, t) {
          ...
          !(function endOperations(e) {
            ...
            for (var r = 0; r < t.length; r++)
              (i = t[r]).updatedDisplay = i.mustUpdate && updateDisplayIfNeeded(i.cm, i.update)
            var i
      ...
      function endOperation_R1(e) {
        ...
        !(function maybeClipScrollbars(e) {
          ...
          (e.update =
            e.mustUpdate && new fe(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate))
      }
      function endOperation_R2(e) {
        ...
        e.updatedDisplay && updateHeightsInViewport(t),
          ...
          n.maxLineChanged &&
            ...
            ((e.adjustWidthTo = measureChar(t, n.maxLine, n.maxLine.text.length).left + 3),
            ...
            (e.maxScrollLeft = Math.max(0, n.sizer.offsetLeft + e.adjustWidthTo - displayWidth(t)))),
      ...
      function endOperation_W2(e) {
        ...
        null != e.adjustWidthTo &&
          ...
          e.maxScrollLeft < t.doc.scrollLeft &&
            setScrollLeft(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
          (t.display.maxLineChanged = !1))
        var n = e.focus && e.focus == activeElt()
        e.preparedSelection && t.display.input.showSelection(e.preparedSelection, n),
          (e.updatedDisplay || e.startHeight != t.doc.height) && updateScrollbars(t, e.barMeasure),
            ...
            (function scrollPosIntoView(e, t, n, r) {
              ...
              null == r && (r = 0),
                e.options.lineWrapping ||
                  t != n ||
                  (n =
                    'before' == (t = t.ch ? Pos(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after') : t).sticky
              ...
              for (var o = 0; o < 5; o++) {
                ...
                if (
                  (null != c.scrollTop &&
                    (updateScrollTop(e, c.scrollTop), Math.abs(e.doc.scrollTop - u) > 1 && (a = !0)),
                  null != c.scrollLeft &&
                    (setScrollLeft(e, c.scrollLeft), Math.abs(e.doc.scrollLeft - d) > 1 && (a = !0)),
                  !a)
                )
                  break
              }
              return i
            })(t, clipPos(r, e.scrollToPos.from), clipPos(r, e.scrollToPos.to), e.scrollToPos.margin),
          )
        var i = e.maybeHiddenMarkers,
          o = e.maybeUnhiddenMarkers
        if (i) for (var a = 0; a < i.length; ++a) i[a].lines.length || signal(i[a], 'hide')
        if (o) for (var s = 0; s < o.length; ++s) o[s].lines.length && signal(o[s], 'unhide')
      ...
      function regChange(e, t, n, r) {
        ...
        if (
          ...
          F && visualLineEndNo(e.doc, n + r) > i.viewFrom ? resetView(e) : ((i.viewFrom += r), (i.viewTo += r))
        else if (t <= i.viewFrom && n >= i.viewTo) resetView(e)
        else if (t <= i.viewFrom) {
          var o = viewCuttingPoint(e, n, n + r, 1)
          o ? ((i.view = i.view.slice(o.index)), (i.viewFrom = o.lineN), (i.viewTo += r)) : resetView(e)
        } else if (n >= i.viewTo) {
        ...
        if (!(t.highlightFrontier >= e.display.viewTo)) {
          ...
          t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function(o) {
            if (r.line >= e.display.viewFrom) {
              var a = o.styles,
                s = o.text.length > e.options.maxHighlightLength ? copyState(t.mode, r.state) : null,
            ...
            } else o.text.length <= e.options.maxHighlightLength && processLine(e, o.text, r), (o.stateAfter = r.line % 5 == 0 ? r.save() : null), r.nextLine()
        ...
        return (
          ...
          (function patchDisplay(e, t, n) {
            ...
            function rm(t) {
              var n = t.nextSibling
              return (
                l && y && e.display.currentWheelTarget == t ? (t.style.display = 'none') : t.parentNode.removeChild(t),
                n
              )
            }
            for (var s = r.view, c = r.viewFrom, u = 0; u < s.length; u++) {
              ...
              if (d.hidden);
                ...
                d.changes && (indexOf(d.changes, 'gutter') > -1 && (p = !1), updateLineForChanges(e, d, c, n)),
                  p &&
                    (removeChildren(d.lineNumber),
                    d.lineNumber.appendChild(document.createTextNode(lineNumberFor(e.options, c)))),
          ...
          (function restoreSelection(e) {
            if (
              ...
              (e.activeElt.focus(),
              e.anchorNode && contains(document.body, e.anchorNode) && contains(document.body, e.focusNode))
            ) {
          ...
          s && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), startWorker(e, 400)),
      ...
      function postUpdateDisplay(e, t) {
        for (
          ...
          ((r && e.options.lineWrapping && t.oldDisplayWidth != displayWidth(e)) ||
            (n &&
              null != n.top &&
              (n = { top: Math.min(e.doc.height + paddingVert(e.display) - displayHeight(e), n.top) }),
      ...
      function updateDisplaySimple(e, t) {
        ...
        if (updateDisplayIfNeeded(e, n)) {
          ...
          updateSelection(e), updateScrollbars(e, r), setDocumentHeight(e, r), n.finish()
        }
      }
      ...
      function setDocumentHeight(e, t) {
        ;(e.display.sizer.style.minHeight = t.docHeight + 'px'),
          ...
          (e.display.gutters.style.height = t.docHeight + e.display.barHeight + scrollGap(e) + 'px')
      }
      ...
      function onScrollWheel(e, t) {
        ...
        if ((i && c) || (o && u)) {
          ...
          if (o && null != me) {
            ...
            g < 0 ? (m = Math.max(0, m + g - 50)) : (v = Math.min(e.doc.height, v + g + 50)),
              ...
              ? ((a.wheelStartX = s.scrollLeft),
                ...
                setTimeout(function() {
                  if (null != a.wheelStartX) {
                    ...
                    ;(a.wheelStartX = a.wheelStartY = null), n && ((me = (me * ge + n) / (ge + 1)), ++ge)
                  }
                }, 200))
      ...
      ;(ve.prototype.primary = function() {
        ...
        (ve.prototype.equals = function(e) {
          ...
          for (var t = 0; t < this.ranges.length; t++) {
            var n = this.ranges[t],
              r = e.ranges[t]
            if (!equalCursorPos(n.anchor, r.anchor) || !equalCursorPos(n.head, r.head)) return !1
          }
          return !0
        }),
        (ve.prototype.deepCopy = function() {
          for (var e = [], t = 0; t < this.ranges.length; t++)
            e[t] = new ye(copyPos(this.ranges[t].anchor), copyPos(this.ranges[t].head))
      ...
      function changeEnd(e) {
        return e.text
          ? Pos(e.from.line + e.text.length - 1, lst(e.text).length + (1 == e.text.length ? e.from.ch : 0))
          : e.to
      }
      ...
      function updateDoc(e, t, n, r) {
        ...
        function linesFor(e, t) {
          for (var n = [], i = e; i < t; ++i) n.push(new re(a[i], spansFor(i), r))
          return n
        }
        var i = t.from,
          o = t.to,
          ...
          d = o.line - i.line
        if (t.full) e.insert(0, linesFor(0, a.length)), e.remove(a.length, e.size - a.length)
        else if (isWholeLineUpdate(e, t)) {
          var p = linesFor(0, a.length - 1)
          update(l, l.text, u), d && e.remove(i.line, d), p.length && e.insert(i.line, p)
        } else if (s == l)
          if (1 == a.length) update(s, s.text.slice(0, i.ch) + c + s.text.slice(o.ch), u)
          else {
          ...
          update(s, s.text.slice(0, i.ch) + a[0] + l.text.slice(o.ch), spansFor(0)), e.remove(i.line + 1, d)
        else {
          update(s, s.text.slice(0, i.ch) + a[0], spansFor(0)), update(l, c + l.text.slice(o.ch), u)
        ...
        if (
          ...
          for (
            (l && l.ranges) || pushSelectionToHistory(e.sel, i.done),
              o = { changes: [historyChangeFromChange(e, t)], generation: i.generation },
              i.done.push(o);
      ...
      function mergeOldSpans(e, t) {
        var n = (function getOldSpans(e, t) {
            var n = t['spans_' + e.id]
            if (!n) return null
            for (var r = [], i = 0; i < t.text.length; ++i) r.push(removeClearedSpans(n[i]))
            return r
          })(e, t),
          ...
          if (o.ranges) r.push(n ? ve.prototype.deepCopy.call(o) : o)
            ...
            for (var l = 0; l < a.length; ++l) {
              ...
              if ((s.push({ from: c.from, to: c.to, text: c.text }), t))
                for (var d in c)
                  (u = d.match(/^spans_(\d+)$/)) && indexOf(t, Number(u[1])) > -1 && ((lst(s)[d] = c[d]), delete c[d])
            }
          }
        }
        return r
      ...
      function extendRange(e, t, n, r) {
        if (r) {
          ...
          if (n) {
            var o = cmp(t, i) < 0
            o != cmp(n, i) < 0 ? ((i = t), (t = n)) : o != cmp(t, n) < 0 && (t = n)
          }
          return new ye(i, t)
        }
        return new ye(n || t, t)
      ...
      function extendSelection(e, t, n, r, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
          setSelection(e, new ve([extendRange(e.sel.primary(), t, n, i)], 0), r)
      }
      ...
      function setSelectionReplaceHistory(e, t, n) {
        var r = e.history.done,
          i = lst(r)
        i && i.ranges ? ((r[r.length - 1] = t), setSelectionNoUndo(e, t, n)) : setSelection(e, t, n)
      }
      ...
      function setSelectionNoUndo(e, t, n) {
        ;(hasHandler(e, 'beforeSelectionChange') || (e.cm && hasHandler(e.cm, 'beforeSelectionChange'))) &&
      ...
      function setSelectionInner(e, t) {
        t.equals(e.sel) ||
          ((e.sel = t),
          e.cm && ((e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = !0), signalCursorActivity(e.cm)),
      ...
      function skipAtomicInSelection(e, t, n, r) {
        for (var i, o = 0; o < t.ranges.length; o++) {
          ...
          ;(i || l != a.anchor || c != a.head) && (i || (i = t.ranges.slice(0, o)), (i[o] = new ye(l, c)))
        }
        ...
        if (o.markedSpans)
          for (var a = 0; a < o.markedSpans.length; ++a) {
            ...
            if (
              ...
              return (
                (r < 0 ? l.inclusiveLeft : l.inclusiveRight) && (d = movePos(e, d, r, d.line == t.line ? o : null)),
      ...
      function makeChange(e, t, n) {
        ...
        if (
          !(hasHandler(e, 'beforeChange') || (e.cm && hasHandler(e.cm, 'beforeChange'))) ||
                ...
                for (var a = r[o], s = a.find(0), l = 0; l < i.length; ++l) {
                  ...
                  if (!(cmp(c.to, s.from) < 0 || cmp(c.from, s.to) > 0)) {
                    ...
                    ;(d < 0 || (!a.inclusiveLeft && !d)) && u.push({ from: c.from, to: s.from }),
                      (p > 0 || (!a.inclusiveRight && !p)) && u.push({ from: s.to, to: c.to }),
                      i.splice.apply(i, u),
                      (l += u.length - 3)
                  }
                }
          ...
          if (r)
            for (var i = r.length - 1; i >= 0; --i)
              makeChangeInner(e, { from: r[i].from, to: r[i].to, text: i ? [''] : t.text, origin: t.origin })
      ...
      function makeChangeInner(e, t) {
        if (1 != t.text.length || '' != t.text[0] || 0 != cmp(t.from, t.to)) {
          ...
          linkedDocs(e, function(e, n) {
            n || -1 != indexOf(r, e.history) || (rebaseHist(e.history, t), r.push(e.history)),
      ...
      function makeChangeFromHistory(e, t, n) {
        ...
        if (!r || n) {
          ...
          if (c != s.length) {
            ...
            for (
              var d = hasHandler(e, 'beforeChange') || (e.cm && hasHandler(e.cm, 'beforeChange')),
                p = function(n) {
                  var r = i.changes[n]
                  if (((r.origin = t), d && !filterChange(e, r, !1))) return (s.length = 0), {}
                  u.push(historyChangeFromChange(e, r))
                  var o = n ? computeSelAfterChange(e, r) : lst(s)
                  makeChangeSingleDoc(e, r, o, mergeOldSpans(e, r)),
                    !n && e.cm && e.cm.scrollIntoView({ from: r.from, to: changeEnd(r) })
                  var a = []
                  linkedDocs(e, function(e, t) {
                    t || -1 != indexOf(a, e.history) || (rebaseHist(e.history, r), a.push(e.history)),
      ...
      function shiftDoc(e, t) {
        if (
          ...
          for (var n = e.cm.display, r = n.viewFrom; r < n.viewTo; r++) regLineChange(e.cm, r, 'gutter')
        }
      }
      function makeChangeSingleDoc(e, t, n, r) {
        if (e.cm && !e.cm.curOp) return operation(e.cm, makeChangeSingleDoc)(e, t, n, r)
        if (t.to.line < e.first) shiftDoc(e, t.text.length - 1 - (t.to.line - t.from.line))
        else if (!(t.from.line > e.lastLine())) {
          if (t.from.line < e.first) {
            var i = t.text.length - 1 - (e.first - t.from.line)
            shiftDoc(e, i),
              (t = { from: Pos(e.first, 0), to: Pos(t.to.line + i, t.to.ch), text: [lst(t.text)], origin: t.origin })
          }
          var o = e.lastLine()
          t.to.line > o &&
            (t = { from: t.from, to: Pos(o, getLine(e, o).text.length), text: [t.text[0]], origin: t.origin }),
            ...
            e.cm
              ? (function makeChangeSingleDocInEditor(e, t, n) {
                  ...
                  t.full
                    ? regChange(e)
                    : o.line != a.line || 1 != t.text.length || isWholeLineUpdate(e.doc, t)
      ...
      function replaceRange(e, t, n, r, i) {
        ...
        'string' == typeof t && (t = e.splitLines(t)), makeChange(e, { from: n, to: r, text: t, origin: i })
      }
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          if (o.ranges) {
            ...
            for (var s = 0; s < o.ranges.length; s++)
              rebaseHistSelSingle(o.ranges[s].anchor, t, n, r), rebaseHistSelSingle(o.ranges[s].head, t, n, r)
          } else {
            for (var l = 0; l < o.changes.length; ++l) {
              var c = o.changes[l]
              if (n < c.from.line) (c.from = Pos(c.from.line + r, c.from.ch)), (c.to = Pos(c.to.line + r, c.to.ch))
              else if (t <= c.to.line) {
                a = !1
                break
              }
      ...
      function changeLine(e, t, n, r) {
        var i = t,
          o = t
        return (
          'number' == typeof t ? (o = getLine(e, clipLine(e, t))) : (i = lineNo(t)),
      ...
      ;(ye.prototype.from = function() {
        ...
        (LeafChunk.prototype = {
          ...
          removeInner: function(e, t) {
            for (var n = e, r = e + t; n < r; ++n) {
              var i = this.lines[n]
              ;(this.height -= i.height), cleanUpLine(i), signalLater(i, 'delete')
            }
        ...
        (BranchChunk.prototype = {
          ...
          removeInner: function(e, t) {
            ...
            if (this.size - t < 25 && (this.children.length > 1 || !(this.children[0] instanceof LeafChunk))) {
              var s = []
          ...
          maybeSpill: function() {
            if (!(this.children.length <= 10)) {
              var e = this
              do {
                var t = new BranchChunk(e.children.splice(e.children.length - 5, 5))
                if (e.parent) {
      ...
      ;(be.prototype.clear = function() {
        ...
        if (null != r && t) {
          ...
          updateLineHeight(n, Math.max(0, n.height - o)),
            e &&
              (runInOp(e, function() {
                adjustScrollWhenAboveVisible(e, n, -o), regLineChange(e, r, 'widget')
              }),
      ...
      function markText(e, t, n, r, i) {
          ...
          return (function markTextShared(e, t, n, r, i) {
            ...
            return (
              linkedDocs(e, function(e) {
                s && (r.widgetNode = s.cloneNode(!0)), o.push(markText(e, clipPos(e, t), clipPos(e, n), r, i))
        ...
        if (e.cm && !e.cm.curOp) return operation(e.cm, markText)(e, t, n, r, i)
        var o = new Ce(e, i),
          a = cmp(t, n)
        if ((r && copyObj(r, o, !1), a > 0 || (0 == a && !1 !== o.clearWhenEmpty))) return o
        if (
          (o.replacedWith &&
            ((o.collapsed = !0),
            (o.widgetNode = eltP('span', [o.replacedWith], 'CodeMirror-widget')),
        ...
        o.addToHistory && addChangeToHistory(e, { from: t, to: n, origin: 'markText' }, e.sel, NaN)
        var s,
          l = t.line,
          c = e.cm
        if (
          (e.iter(l, n.line + 1, function(e) {
            c && o.collapsed && !c.options.lineWrapping && visualLine(e) == c.display.maxLine && (s = !0),
              o.collapsed && l != t.line && updateLineHeight(e, 0),
              (function addMarkedSpan(e, t) {
                ;(e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t]), t.marker.attachLine(e)
              })(e, new MarkedSpan(o, l == t.line ? t.ch : null, l == n.line ? n.ch : null)),
              ++l
          }),
          o.collapsed &&
          ...
          if ((s && (c.curOp.updateMaxLine = !0), o.collapsed)) regChange(c, t.line, n.line + 1)
          else if (o.className || o.title || o.startStyle || o.endStyle || o.css)
            for (var u = t.line; u <= n.line; u++) regLineChange(c, u, 'text')
          o.atomic && reCheckSelection(c.doc), signalLater(c, 'markerAdded', c, o)
        }
        return o
      }
      ;(Ce.prototype.clear = function() {
        if (!this.explicitlyCleared) {
          ...
          for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
            ...
            e && !this.collapsed
              ...
              : e && (null != s.to && (i = lineNo(a)), null != s.from && (r = lineNo(a))),
          ...
          null != r && e && this.collapsed && regChange(e, r, i + 1),
            ...
            this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), e && reCheckSelection(e.doc)),
        ...
        (Ce.prototype.find = function(e, t) {
          ...
          for (var i = 0; i < this.lines.length; ++i) {
            ...
            if (null != a.from && ((n = Pos(t ? o : lineNo(o), a.from)), -1 == e)) return n
            if (null != a.to && ((r = Pos(t ? o : lineNo(o), a.to)), 1 == e)) return r
          }
        ...
        (Ce.prototype.changed = function() {
          ...
          t &&
            ...
            runInOp(r, function() {
              ...
              if (
                (a && (clearLineMeasurementCacheFor(a), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
        ...
        for (
          var t = function(t) {
              ...
              for (var i = 0; i < n.markers.length; i++) {
                var o = n.markers[i]
                ;-1 == indexOf(r, o.doc) && ((o.parent = null), n.markers.splice(i--, 1))
              }
            },
            n = 0;
          n < e.length;
      ...
      ;(ke.prototype = createObj(BranchChunk.prototype, {
        ...
        replaceRange: function(e, t, n, r) {
          replaceRange(this, e, (t = clipPos(this, t)), (n = n ? clipPos(this, n) : t), r)
        },
        ...
        setSelections: docMethodOp(function(e, t, n) {
          if (e.length) {
            for (var r = [], i = 0; i < e.length; i++)
              r[i] = new ye(clipPos(this, e[i].anchor), clipPos(this, e[i].head))
          ...
          this.iter(function(n) {
            n.gutterMarkers &&
              ...
              changeLine(t, n, 'gutter', function() {
                return (n.gutterMarkers[e] = null), isEmpty(n.gutterMarkers) && (n.gutterMarkers = null), !0
              })
          })
        }),
        lineInfo: function(e) {
        ...
        addLineWidget: docMethodOp(function(e, t, n) {
          return (function addLineWidget(e, t, n, r) {
            ...
            return (
              ...
              o && signalLater(o, 'lineWidgetAdded', o, i, 'number' == typeof t ? t : lineNo(t)),
              i
            )
          })(this, e, t, n)
        }),
        ...
        linkedDoc: function(e) {
          ...
          var r = new ke(getLines(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction)
          return (
      ...
      function onDrop(e) {
        var t = this
        if ((clearDragCursor(t), !signalDOMEvent(t, e) && !eventInWidget(t.display, e))) {
            ...
            if (r && r.length && window.FileReader && window.File)
              for (
                var i = r.length,
                  ...
                  s = 0,
                  l = function(e, r) {
                    if (!t.options.allowDropFileTypes || -1 != indexOf(t.options.allowDropFileTypes, e.type)) {
              ...
              try {
                ...
                if (u) {
                  ...
                  if (
                    ...
                    for (var p = 0; p < d.length; ++p) replaceRange(t.doc, '', d[p].anchor, d[p].head, 'drag')
      ...
      function normalizeKeyMap(e) {
        ...
        for (var n in e)
          if (e.hasOwnProperty(n)) {
            ...
            for (var i = map(n.split(' '), normalizeKeyName), o = 0; o < i.length; o++) {
              var a = void 0,
                s = void 0
      ...
      function deleteNearSelection(e, t) {
        ...
        runInOp(e, function() {
          for (var t = r.length - 1; t >= 0; t--) replaceRange(e.doc, '', r[t].from, r[t].to, '+delete')
      ...
      function endOfLine(e, t, n, r, i) {
        ...
        return new Pos(r, i < 0 ? n.text.length : 0, i < 0 ? 'before' : 'after')
      }
      ;(Ne.basic = {
        Left: 'goCharLeft',
        Right: 'goCharRight',
      ...
      var De = {
        ...
        deleteLine: function(e) {
          return deleteNearSelection(e, function(t) {
            return { from: Pos(t.from().line, 0), to: clipPos(e.doc, Pos(t.to().line + 1, 0)) }
          })
        },
        ...
        goLineLeftSmart: function(e) {
          return e.extendSelectionsBy(function(t) {
            ...
            return r.ch < e.getLine(r.line).search(/\S/) ? lineStartSmart(e, t.head) : r
          }, D)
        },
        goLineUp: function(e) {
          ...
          return runInOp(e, function() {
            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
              if (t[r].empty()) {
                ...
                if (o)
                  if ((i.ch == o.length && (i = new Pos(i.line, i.ch - 1)), i.ch > 0))
                    (i = new Pos(i.line, i.ch + 1)),
                      e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), Pos(i.line, i.ch - 2), i, '+transpose')
      ...
      function dispatchKeyInner(e, t, n, r) {
        var i = (function lookupKeyForEditor(e, t, n) {
          ...
          return (
            (e.options.extraKeys && lookupKey(t, e.options.extraKeys, n, e)) || lookupKey(t, e.options.keyMap, n, e)
          )
        })(e, t, r)
        return (
          'multi' == i && (e.state.keySeq = t),
          'handled' == i && signalLater(e, 'keyHandled', e, t, n),
          ('handled' != i && 'multi' != i) || (e_preventDefault(n), restartBlink(e)),
          !!i
        )
      }
          ...
          (t.shiftKey && !e.state.keySeq
            ? dispatchKey(e, 'Shift-' + n, t, function(t) {
              ...
              dispatchKey(e, n, t, function(t) {
                if ('string' == typeof t ? /^go[A-Z]/.test(t) : t.motion) return doHandleBinding(e, t)
              })
            : dispatchKey(e, n, t, function(t) {
      ...
      function onKeyDown(e) {
        ...
        if (((t.curOp.focus = activeElt()), !signalDOMEvent(t, e))) {
          ...
          d &&
            ((We = r ? n : null),
            !r && 88 == n && !q && (y ? e.metaKey : e.ctrlKey) && t.replaceSelection('', null, 'cut')),
            18 != n ||
              ...
              (function showCrossHair(e) {
                ...
                function up(e) {
                  ;(18 != e.keyCode && e.altKey) ||
                    (L(t, 'CodeMirror-crosshair'), off(document, 'keyup', up), off(document, 'mouseover', up))
                }
                addClass(t, 'CodeMirror-crosshair'), V(document, 'keyup', up), V(document, 'mouseover', up)
              })(t)
        }
      }
      function onKeyUp(e) {
      ...
      function onKeyPress(e) {
        var t = this
        if (!(eventInWidget(t.display, e) || signalDOMEvent(t, e) || (e.ctrlKey && !e.altKey) || (y && e.metaKey))) {
          var n = e.keyCode,
            r = e.charCode
            ...
            window.focus(),
              ...
              (r &&
                (function handleMappedButton(e, t, n, r, i) {
                  ...
                  return dispatchKey(
                    e,
                    addModifierNames((o = (1 == t ? 'Left' : 2 == t ? 'Middle' : 'Right') + o), i),
                    i,
                    function(t) {
                        ...
                        (cmp(i.to(), t) > 0 || t.xRel < 0)
                              ...
                              var i = e.display,
                                ...
                                c = operation(e, function(t) {
                                  l && (i.scroller.draggable = !1),
                                    ...
                                    off(i.wrapper.ownerDocument, 'mousemove', u),
                          ...
                          : (function leftButtonSelect(e, t, n, r) {
                              ...
                              var a,
                                ...
                                c = l.ranges
                              r.addNew && !r.extend
                                ? ((s = o.sel.contains(n)), (a = s > -1 ? c[s] : new ye(n, n)))
                              ...
                              r.addNew
                                ? -1 == s
                                  ...
                                  : c.length > 1 && c[s].empty() && 'char' == r.unit && !r.extend
                                    ? (setSelection(o, normalizeSelection(c.slice(0, s).concat(c.slice(s + 1)), 0), {
                                        scroll: !1,
                                        origin: '*mouse',
                                      }),
                                      (l = o.sel))
                                    : replaceOneSelection(o, s, a, N)
                                : ((s = 0), setSelection(o, new ve([a], 0), N), (l = o.sel))
                              var d = n
                              function extendTo(t) {
                                if (0 != cmp(d, t))
                                  if (((d = t), 'rectangle' == r.unit)) {
                                    for (
                                      ...
                                      h == f
                                        ...
                                        : v.length > y && i.push(new ye(Pos(g, y), Pos(g, findColumn(v, f, c))))
                                    }
                                    i.length || i.push(new ye(n, n)),
                                      setSelection(o, normalizeSelection(l.ranges.slice(0, s).concat(i), s), {
                                        origin: '*mouse',
                                        scroll: !1,
                                      }),
                                      e.scrollIntoView(t)
                                    ...
                                    ;(S[s] = (function bidiSimplify(e, t) {
                                      ...
                                      setSelection(o, normalizeSelection(S, s), N)
                                  }
                              }
                              ...
                              var f = operation(e, function(t) {
                                  e_button(t)
                                    ? (function extend(t) {
                                        var n = ++h
                                        var a = posFromMouse(e, t, !0, 'rectangle' == r.unit)
                                        if (!a) return
                                        if (0 != cmp(a, d)) {
      ...
      function gutterEvent(e, t, n, r) {
        ...
        for (var l = 0; l < e.options.gutters.length; ++l) {
          ...
          if (c && c.getBoundingClientRect().right >= i)
            return signal(e, n, e, lineAtHeight(e.doc, o), e.options.gutters[l], t), e_defaultPrevented(t)
        }
      }
      ...
      function CodeMirror$1(e, t) {
        ...
        ;(this.options = t = t ? copyObj(t) : {}), copyObj(ze, t, !1), setGuttersForLineNumbers(t)
        var i = t.value
        'string' == typeof i && (i = new ke(i, t.mode, null, t.lineSeparator, t.direction)), (this.doc = i)
        var o = new CodeMirror$1.inputStyles[t.inputStyle](this),
          c = (this.display = new function Display(e, t, r) {
            ...
            ;(this.input = r),
              ...
              (i.selectionDiv = elt('div', null, null, 'position: relative; z-index: 1')),
            ...
            ;(i.mover = elt('div', [o], null, 'position: relative')),
              ...
              (i.sizerWidth = null),
              (i.heightForcer = elt('div', null, null, 'position: absolute; height: ' + O + 'px; width: 1px;')),
              (i.gutters = elt('div', null, 'CodeMirror-gutters')),
              (i.lineGutter = null),
              (i.scroller = elt('div', [i.sizer, i.heightForcer, i.gutters], 'CodeMirror-scroll')),
              i.scroller.setAttribute('tabIndex', '-1'),
              (i.wrapper = elt('div', [i.scrollbarFiller, i.gutterFiller, i.scroller], 'CodeMirror')),
              a && s < 8 && ((i.gutters.style.zIndex = -1), (i.scroller.style.paddingRight = 0)),
        ...
        (function registerEventHandlers(e) {
          ...
          V(t.scroller, 'touchstart', function(i) {
            ...
            V(t.scroller, 'touchend', function(n) {
              var r = t.activeTouch
              if (r && !eventInWidget(t, n) && null != r.left && !r.moved && new Date() - r.start < 300) {
                var i,
                ...
                ;(i =
                  !r.prev || farAway(r, r.prev)
                    ...
                    : !r.prev.prev || farAway(r, r.prev.prev)
                      ? e.findWordAt(o)
                      : new ye(Pos(o.line, 0), clipPos(e.doc, Pos(o.line + 1, 0)))),
                    ...
                    if (n) {
                      ...
                      drawSelectionCursor(e, n, r),
                        e.display.dragCursor ||
                          ((e.display.dragCursor = elt('div', null, 'CodeMirror-cursors CodeMirror-dragcursors')),
        ...
        attachDoc(this, i),
        (t.autofocus && !v) || this.hasFocus() ? setTimeout(bind(onFocus, this), 20) : onBlur(this),
        Re))
      ...
      function indentLine(e, t, n, r) {
        var i,
          o = e.doc
        null == n && (n = 'add'), 'smart' == n && (o.mode.indent ? (i = getContextBefore(e, t).state) : (n = 'prev'))
        ...
        var d = '',
          p = 0
        if (e.options.indentWithTabs) for (var h = Math.floor(c / a); h; --h) (p += a), (d += '\t')
        if ((p < c && (d += spaceStr(c - p)), d != u))
          return replaceRange(o, d, Pos(t, 0), Pos(t, u.length), '+input'), (s.stateAfter = null), !0
        ...
        if (s && r.ranges.length > 1)
          if (Ue && Ue.text.join('\n') == t) {
            if (r.ranges.length % Ue.text.length == 0) {
              c = []
              for (var u = 0; u < Ue.text.length; u++) c.push(o.splitLines(Ue.text[u]))
            }
          } else
        ...
        for (var d = r.ranges.length - 1; d >= 0; d--) {
          ...
          p.empty() &&
            (n && n > 0
              ? (h = Pos(h.line, h.ch - n))
              : e.state.overwrite && !s
                ? (f = Pos(f.line, Math.min(getLine(o, f.line).text.length, f.ch + lst(l).length)))
                : Ue && Ue.lineWise && Ue.text.join('\n') == t && (h = f = Pos(h.line, 0))),
          ...
          for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
            ...
            if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
              ...
              if (o.electricChars) {
                ...
                o.electricInput &&
                  o.electricInput.test(getLine(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
                  (a = indentLine(e, i.head.line, 'smart'))
      ...
      function findPosH(e, t, n, r, i) {
          ...
          if (
            ...
            (o = i
              ? (function moveVisually(e, t, n, r) {
                  ...
                  var s,
                    ...
                    c = function(n) {
                      return e.options.lineWrapping
                        ? ((s = s || prepareMeasureForLine(e, t)), wrappedLineExtentChar(e, t, s, n))
                  ...
                  if ('rtl' == e.doc.direction || 1 == a.level) {
                    var d = (1 == a.level) == r < 0,
                      p = l(n, d ? 1 : -1)
                    if (null != p && (d ? p <= a.to && p <= u.end : p >= a.from && p >= u.begin)) {
                  ...
                  var f = function(e, t, r) {
                      for (
                        var o = function(e, t) {
                          return t ? new Pos(n.line, l(e, 1), 'before') : new Pos(n.line, e, 'after')
                        };
                        e >= 0 && e < i.length;
                        e += t
                      ) {
                  ...
                  return null == m || (r > 0 && m == t.text.length) || !(g = f(r > 0 ? 0 : i.length - 1, r, c(m)))
                    ? null
                    : g
                })(e.cm, s, t, n)
              : moveLogically(s, t, n))
            ...
            if (
              ...
              !(function findNextLine() {
                var r = t.line + n
                return (
                  !(r < e.first || r >= e.first + e.size) && ((t = new Pos(r, t.ch, t.sticky)), (s = getLine(e, r)))
                )
              })()
            )
              return !1
        ...
        if ('char' == r) moveOnce()
          ...
          for (
            var l = null, c = 'group' == r, u = e.cm && e.cm.getHelper(t, 'wordChars'), d = !0;
            !(n < 0) || moveOnce(!d);
            d = !1
          ) {
      ...
      function domToPos(e, t, n) {
        ...
        if (t == e.display.lineDiv) {
          if (!(r = e.display.lineDiv.childNodes[n])) return badPos(e.clipPos(Pos(e.display.viewTo - 1)), !0)
          ;(t = null), (n = 0)
        } else
      ...
      function locateNodeInLineView(e, t, n) {
        ...
        for (var d = s.nextSibling, p = a ? a.nodeValue.length - n : 0; d; d = d.nextSibling) {
          if ((u = find(d, d.firstChild, 0))) return badPos(Pos(u.line, u.ch - p), i)
          p += d.textContent.length
        }
        for (var h = s.previousSibling, f = n; h; h = h.previousSibling) {
          if ((u = find(h, h.firstChild, -1))) return badPos(Pos(u.line, u.ch + f), i)
      ...
      ;(je.prototype.init = function(e) {
        ...
        function onCopyCut(e) {
          if (!signalDOMEvent(r, e)) {
              ...
              setLastCopied({ lineWise: !0, text: t.text }),
                'cut' == e.type &&
                  r.operation(function() {
                    r.setSelections(t.ranges, 0, A), r.replaceSelection('', null, 'cut')
                  })
            }
            if (e.clipboardData) {
            ...
            var a = hiddenTextarea(),
              s = a.firstChild
            r.display.lineSpace.insertBefore(a, r.display.lineSpace.firstChild), (s.value = Ue.text.join('\n'))
        ...
        (je.prototype.showPrimarySelection = function() {
          ...
          if (t.display.viewTo == t.display.viewFrom || i.line >= t.display.viewTo || o.line < t.display.viewFrom)
            ...
            if (!a || a.bad || !s || s.bad || 0 != cmp(minPos(a, s), i) || 0 != cmp(maxPos(a, s), o)) {
              var l = t.display.view,
                c = (i.line >= t.display.viewFrom && posToDOM(t, i)) || { node: l[0].measure.map[2], offset: 0 },
              ...
              if (c && u) {
                ...
                h &&
                  (!n && t.state.focused
                    ? (e.collapse(c.node, c.offset), h.collapsed || (e.removeAllRanges(), e.addRange(h)))
          ...
          if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
            ...
            if (!this.composing) {
              ...
              n &&
                r &&
                runInOp(t, function() {
                  setSelection(t.doc, simpleSelection(n, r), A), (n.bad || r.bad) && (t.curOp.selectionChanged = !0)
                })
            }
          }
        }),
        (je.prototype.pollContent = function() {
          ...
          var e,
            ...
            s = o.to()
          if (
            (0 == a.ch && a.line > r.firstLine() && (a = Pos(a.line - 1, getLine(r.doc, a.line - 1).length)),
            s.ch == getLine(r.doc, s.line).text.length && s.line < r.lastLine() && (s = Pos(s.line + 1, 0)),
            a.line < i.viewFrom || s.line > i.viewTo - 1)
          )
            return !1
          a.line == i.viewFrom || 0 == (e = findViewIndex(r, a.line))
            ? ((t = lineNo(i.view[0].line)), (n = i.view[0].node))
            : ((t = lineNo(i.view[e].line)), (n = i.view[e - 1].node.nextSibling))
          var l,
            c,
          ...
          if (
            (u == i.view.length - 1
              ...
              : ((l = lineNo(i.view[u + 1].line) - 1), (c = i.view[u + 1].node.previousSibling)),
            !n)
          )
            return !1
          for (
                ...
                (function domTextBetween(e, t, n, r, i) {
                  ...
                  function walk(t) {
                    if (1 == t.nodeType) {
                      ...
                      if (null != n) return void addText(n || t.textContent.replace(/\u200b/g, ''))
                      var o,
                      ...
                      if (l) {
                        ...
                        return void (c.length && (o = c[0].find(0)) && addText(getBetween(e.doc, o.from, o.to).join(s)))
                      }
          ...
          for (
            var y = lst(d),
              b = lst(p),
              x = Math.min(y.length - (1 == d.length ? h : 0), b.length - (1 == p.length ? h : 0));
            f < x && y.charCodeAt(y.length - f - 1) == b.charCodeAt(b.length - f - 1);

          )
            ++f
          if (1 == d.length && 1 == p.length && t == a.line)
            for (; h && h > a.ch && y.charCodeAt(y.length - f - 1) == b.charCodeAt(b.length - f - 1); ) h--, f++
          ;(d[d.length - 1] = y.slice(0, y.length - f).replace(/^\u200b+/, '')),
            (d[0] = d[0].slice(h).replace(/\u200b+$/, ''))
          var C = Pos(t, h),
            w = Pos(l, p.length ? lst(p).length - f : 0)
          return d.length > 1 || d[0] || cmp(C, w) ? (replaceRange(r.doc, d, C, w, '+input'), !0) : void 0
        }),
      ...
      ;(Ge.prototype.init = function(e) {
        ...
        function prepareCopyCut(e) {
          if (!signalDOMEvent(r, e)) {
            if (r.somethingSelected()) setLastCopied({ lineWise: !1, text: r.getSelections() })
            else {
              if (!r.options.lineWiseCopyCut) return
              var t = copyableRanges(r)
              setLastCopied({ lineWise: !0, text: t.text }),
        ...
        e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
          ...
          V(i, 'paste', function(e) {
            signalDOMEvent(r, e) || handlePaste(e, r) || ((r.state.pasteIncoming = !0), n.fastPoll())
          }),
          V(i, 'cut', prepareCopyCut),
          V(i, 'copy', prepareCopyCut),
          V(e.scroller, 'paste', function(t) {
            eventInWidget(e, t) || signalDOMEvent(r, t) || ((r.state.pasteIncoming = !0), n.focus())
          }),
        ...
        (Ge.prototype.reset = function(e) {
          if (!this.contextMenuPending && !this.composing) {
            ...
            if (t.somethingSelected()) {
              ...
              ;(this.textarea.value = n), t.state.focused && M(this.textarea), a && s >= 9 && (this.hasSelection = n)
        ...
        (Ge.prototype.focus = function() {
          if ('nocursor' != this.cm.options.readOnly && (!v || activeElt() != this.textarea))
            try {
              this.textarea.focus()
            } catch (e) {}
        }),
        ...
        (Ge.prototype.fastPoll = function() {
          ...
          ;(t.pollingFast = !0),
            t.polling.set(20, function p() {
              t.poll() || e ? ((t.pollingFast = !1), t.slowPoll()) : ((e = !0), t.polling.set(60, p))
            })
        }),
        (Ge.prototype.poll = function() {
          ...
          return (
            runInOp(t, function() {
              applyTextInput(t, i.slice(l), r.length - l, null, e.composing ? '*compose' : null),
          ...
          ;(e.defineOption = option),
            ...
            option('lineSeparator', null, function(e, t) {
              if (((e.doc.lineSep = t), t)) {
                ...
                for (var i = n.length - 1; i >= 0; i--) replaceRange(e.doc, t, n[i], Pos(n[i].line, n[i].ch + t.length))
              }
            }),
        ...
        (function(e) {
          ...
          ;(e.prototype = {
            ...
            cursorCoords: function(e, t) {
              ...
              return cursorCoords(
                this,
                null == e ? n.head : 'object' == typeof e ? clipPos(this.doc, e) : e ? n.from() : n.to(),
                t || 'page',
              )
            },
            ...
            heightAtLine: function(e, t, n) {
              ...
              if ('number' == typeof e) {
                ...
                e < this.doc.first ? (e = this.doc.first) : e > o && ((e = o), (i = !0)), (r = getLine(this.doc, e))
              } else r = e
              return (
                intoCoordSystem(this, r, { top: 0, left: 0 }, t || 'page', n || i).top +
            ...
            findPosH: function(e, t, n, r) {
              var i = 1
              t < 0 && ((i = -1), (t = -t))
              for (var o = clipPos(this.doc, e), a = 0; a < t && !(o = findPosH(this.doc, o, i, n, r)).hitSide; ++a);
              return o
            },
            ...
            findPosV: function(e, t, n, r) {
              ...
              for (var a = clipPos(this.doc, e), s = 0; s < t; ++s) {
                ...
                if ((null == o ? (o = l.left) : (l.left = o), (a = findPosV(this, l, i, n)).hitSide)) break
              }
              return a
            },
            moveV: methodOp(function(e, t) {
              ...
              if (
                (r.extendSelectionsBy(function(a) {
                  ...
                  return (
                    'page' == t && a == r.sel.primary() && addToScrollTop(n, charCoords(n, l, 'div').top - s.top), l
                  )
                }, D),
                i.length)
              )
            ...
            refresh: methodOp(function() {
              ...
              regChange(this),
                ...
                (null == e || Math.abs(e - textHeight(this.display)) > 0.5) && estimateLineHeights(this),
                signal(this, 'refresh', this)
            }),
      ...
      return (
        ...
        (CodeMirror$1.defineMode = function(e) {
          CodeMirror$1.defaults.mode || 'null' == e || (CodeMirror$1.defaults.mode = e),
            function defineMode(e, t) {
              arguments.length > 2 && (t.dependencies = Array.prototype.slice.call(arguments, 2)), (Y[e] = t)
            ...
            ;(t.save = save),
              ...
              (t.toTextArea = function() {
                ;(t.toTextArea = isNaN),
                  ...
                  (e.style.display = ''),
                  e.form && (off(e.form, 'submit', save), 'function' == typeof e.form.submit && (e.form.submit = r))
              })
          }),
          ...
          return (
            ...
            (Shared.prototype.applyNext = function(e, t, n) {
              e &&
                ...
                e && e.scroll && t && t.scroll && !l.equals(e.scroll, t.scroll) && this.delegateScroll(t.scroll)
            }),
            (Shared.prototype.applyUserDefined = function(e, t) {
              t && t.cursor && this.delegateCursor(t.cursor, e.autoScroll || !1, e.autoFocus || !1)
            }),
        ...
        u = (function(e) {
          ...
          return (
            ...
            (Controlled.prototype.hydrate = function(e) {
              var t = this,
                n = Object.assign({}, o.defaults, this.editor.options, e.options || {})
            ...
            (Controlled.prototype.initChange = function(e) {
              ...
              this.editor.replaceRange(e || '', { line: 0, ch: 0 }, { line: t, ch: n }),
            ...
            (Controlled.prototype.componentDidMount = function() {
              ...
              s ||
                (this.props.defineMode &&
                  ...
                  o.defineMode(this.props.defineMode.name, this.props.defineMode.fn),
                ...
                this.props.onCursorActivity && this.shared.wire('onCursorActivity'),
                ...
                this.props.onViewportChange && this.shared.wire('onViewportChange'),
            ...
            (Controlled.prototype.componentWillReceiveProps = function(e) {
              if (!s) {
                ...
                e.value !== this.props.value && (this.hydrated = !1),
                  this.props.autoCursor || void 0 === this.props.autoCursor || (t.cursor = this.editor.getCursor()),
                  this.hydrate(e),
                  this.appliedNext || (this.shared.applyNext(this.props, e, t), (this.appliedNext = !0)),
          ...
          (UnControlled.prototype.hydrate = function(e) {
            ...
            if (
              (Object.keys(n).some(function(e) {
                ...
                Object.keys(n).forEach(function(r) {
                  e.options.hasOwnProperty(r) && t.editor.getOption(r) !== n[r] && t.editor.setOption(r, n[r])
                }),
              !this.hydrated)
            ) {
              var r = this.editor.lastLine(),
                i = this.editor.getLine(this.editor.lastLine()).length
              this.editor.replaceRange(e.value || '', { line: 0, ch: 0 }, { line: r, ch: i })
            }
            this.hydrated = !0
          }),
          ...
          (UnControlled.prototype.componentWillReceiveProps = function(e) {
            if (
              ...
              e.value !== this.props.value &&
                ...
                this.appliedUserDefined || (this.shared.applyUserDefined(this.props, t), (this.appliedUserDefined = !0))
            }
          }),
          ...
          function token(n, o) {
            return o.context.mode == r
              ? (function xmlToken(n, o, a) {
                  if (2 == a.depth) return n.match(/^.*?\*\//) ? (a.depth = 1) : n.skipToEnd(), 'comment'
                  if ('{' == n.peek()) {
                    ...
                    if (l && n.match(/^[^>]*>\s*$/, !1)) {
                      ...
                      l.startOfLine ? (s -= t.indentUnit) : a.prev.state.lexical && (s = a.prev.state.lexical.indented)
                    } else 1 == a.depth && (s += t.indentUnit)
                    return (o.context = new Context(e.startState(i, s), i, 0, o.context)), null
                  }
                  if (1 == a.depth) {
                    if ('<' == n.peek())
                      return (
                        r.skipAttribute(a.state),
                        (o.context = new Context(e.startState(r, flatXMLIndent(a.state)), r, 0, o.context)),
                        null
                      )
              ...
              : (function jsToken(t, n, o) {
                  if ('<' == t.peek() && i.expressionAllowed(t, o.state))
                    return (
                      ...
                      (n.context = new Context(e.startState(r, i.indent(o.state, '')), r, 0, n.context)),
                      null
                    )
                  var a = i.token(t, o.state)
                  if (!a && null != o.depth) {
                    var s = t.current()
                    '{' == s ? o.depth++ : '}' == s && 0 == --o.depth && (n.context = n.context.prev)
                  }
                  return a
                })(n, o, o.context)
          }
            ...
            copyState: function(t) {
              return {
                context: (function copyContext(t) {
                  return new Context(e.copyState(t.mode, t.state), t.mode, t.depth, t.prev && copyContext(t.prev))
                })(t.context),
              }
            },
            token: token,
    ...
    ;(function(e) {
      ...
      e.defineMode('xml', function(r, i) {
              ...
              ? e.eat('[')
                ...
                : e.match('--')
                  ...
                  : e.match('DOCTYPE', !0, !0)
                    ...
                    : null
              : e.eat('?')
                ? (e.eatWhile(/[\w\._\-]/), (t.tokenize = inBlock('meta', '?>')), 'meta')
                : ((o = e.eat('/') ? 'closeTag' : 'openTag'), (t.tokenize = inTag), 'tag bracket')
            : '&' == n
              ? (e.eat('#')
                ? e.eat('x')
        ...
        function inTag(e, t) {
          var n = e.next()
          if ('>' == n || ('/' == n && e.eat('>')))
            return (t.tokenize = inText), (o = '>' == n ? 'endTag' : 'selfcloseTag'), 'tag bracket'
        ...
        function maybePopContext(e, t) {
          for (var n; ; ) {
            if (!e.context) return
            if (
              ((n = e.context.tagName), !l.contextGrabbers.hasOwnProperty(n) || !l.contextGrabbers[n].hasOwnProperty(t))
            )
              return
            popContext(e)
          }
        ...
        function closeState(e, t, n) {
          return 'endTag' != e ? ((a = 'error'), closeState) : (popContext(n), baseState)
        }
        ...
        function attrEqState(e, t, n) {
          return 'equals' == e ? attrValueState : (l.allowMissing || (a = 'error'), attrState(e, 0, n))
        }
        ...
        return (
          (inText.isInText = !0),
          {
            ...
            indent: function(t, n, r) {
              ...
              if (t.tokenize != inTag && t.tokenize != inText) return r ? r.match(/^(\s*)/)[0].length : 0
              if (t.tagName)
    ...
    ;(function(e) {
      ...
      e.defineMode('javascript', function(t, n) {
        ...
        function tokenBase(e, t) {
            ...
            return (
              (t.tokenize = (function tokenString(e) {
                return function(t, n) {
                  var r,
                    i = !1
                  if (s && '@' == t.peek() && t.match(h)) return (n.tokenize = tokenBase), ret('jsonld-keyword', 'meta')
          ...
          if ('.' == n && e.match(/^\d+(?:[eE][+\-]?\d+)?/)) return ret('number', 'number')
          if ('.' == n && e.match('..')) return ret('spread', 'meta')
          if (/[\[\]{}\(\),;\:\.]/.test(n)) return ret(n)
          if ('=' == n && e.eat('>')) return ret('=>', 'operator')
          if ('0' == n && e.eat(/x/i)) return e.eatWhile(/[\da-f]/i), ret('number', 'number')
          if ('0' == n && e.eat(/o/i)) return e.eatWhile(/[0-7]/i), ret('number', 'number')
          if ('0' == n && e.eat(/b/i)) return e.eatWhile(/[01]/i), ret('number', 'number')
          if (/\d/.test(n)) return e.match(/^\d*(?:\.\d*)?(?:[eE][+\-]?\d+)?/), ret('number', 'number')
          if ('/' == n)
            return e.eat('*')
          ...
          if (u.test(n)) {
            ...
            if ('.' != t.lastType) {
              ...
              if ('async' == r && e.match(/^(\s|\/\*.*?\*\/)*[\(\w]/, !1)) return ret('async', 'keyword', r)
            }
        ...
        var g = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, 'jsonld-keyword': !0 }
        ...
        function pushcontext() {
          ;(m.state.context = { prev: m.state.context, vars: m.state.localVars }), (m.state.localVars = v)
        }
        function popcontext() {
                          ...
                          : 'function' == e
                            ...
                            : 'for' == e
                              ...
                              : 'class' == e || (c && 'interface' == t)
                                ? ((m.marked = 'keyword'), cont(pushlex('form'), className, poplex))
                                : 'variable' == e
                                  ? c && 'declare' == t
                                    ...
                                    : c && ('module' == t || 'enum' == t || 'type' == t) && m.stream.match(/^\s*\w/, !1)
                                      ...
                                      : c && 'namespace' == t
                                        ? ((m.marked = 'keyword'), cont(pushlex('form'), expression, block, poplex))
        ...
        function parenExpr(e) {
          return '(' != e ? pass() : cont(pushlex(')'), expression, expect(')'), poplex)
        }
        function expressionInner(e, t, n) {
          if (m.state.fatArrowAt == m.stream.start) {
            var r = n ? arrowBodyNoComma : arrowBody
            if ('(' == e)
              return cont(pushcontext, pushlex(')'), commasep(funarg, ')'), poplex, expect('=>'), r, popcontext)
            if ('variable' == e) return pass(pushcontext, pattern, expect('=>'), r, popcontext)
          }
          ...
          return g.hasOwnProperty(e)
            ...
            : 'function' == e
              ? cont(functiondef, i)
              : 'class' == e || (c && 'interface' == t)
                ? ((m.marked = 'keyword'), cont(pushlex('form'), classExpression, poplex))
                : 'keyword c' == e || 'async' == e
                  ? cont(n ? expressionNoComma : expression)
                  : '(' == e
                    ? cont(pushlex(')'), maybeexpression, expect(')'), poplex, i)
                    : 'operator' == e || 'spread' == e
                      ? cont(n ? expressionNoComma : expression)
                      : '[' == e
        ...
        function quasi(e, t) {
          return 'quasi' != e ? pass() : '${' != t.slice(t.length - 2) ? cont(quasi) : cont(expression, continueQuasi)
        }
        function continueQuasi(e) {
          if ('}' == e) return (m.marked = 'string-2'), (m.state.tokenize = tokenQuasi), cont(quasi)
        }
        function arrowBody(e) {
          return findFatArrow(m.stream, m.state), pass('{' == e ? statement : expression)
        }
        function arrowBodyNoComma(e) {
          return findFatArrow(m.stream, m.state), pass('{' == e ? statement : expressionNoComma)
        }
        function target(e, t) {
        ...
        function objprop(e, t) {
          ...
          if ('variable' == e || 'keyword' == m.style) {
            ...
            if ('number' == e || 'string' == e)
              return (m.marked = s ? 'property' : m.style + ' property'), cont(afterprop)
        ...
        function getterSetter(e) {
          return 'variable' != e ? pass(afterprop) : ((m.marked = 'property'), cont(functiondef))
        }
        ...
        function mayberettype(e) {
          if (c && ':' == e)
            return m.stream.match(/^\s*\w+\s+is\b/, !1) ? cont(expression, isKW, typeexpr) : cont(typeexpr)
        }
        function isKW(e, t) {
        ...
        function typeexpr(e, t) {
          return 'keyof' == t || 'typeof' == t
            ? ((m.marked = 'keyword'), cont('keyof' == t ? typeexpr : expression))
            : 'variable' == e || 'void' == t
              ...
              : 'string' == e || 'number' == e || 'atom' == e
                ...
                : '[' == e
                  ...
                  : '{' == e
                    ? cont(pushlex('}'), commasep(typeprop, '}', ',;'), poplex, afterType)
                    : '(' == e
        ...
        function typearg(e) {
          return 'variable' == e ? cont(typearg) : ':' == e ? cont(typeexpr) : void 0
        }
        ...
        function proppattern(e, t) {
          return 'variable' != e || m.stream.match(/^\s*:/, !1)
            ? ('variable' == e && (m.marked = 'property'),
              'spread' == e ? cont(pattern) : '}' == e ? pass() : cont(expect(':'), pattern, maybeAssign))
        ...
        function forspec(e, t) {
          return 'await' == t ? cont(forspec) : '(' == e ? cont(pushlex(')'), forspec1, expect(')'), poplex) : void 0
        }
        function forspec1(e) {
          return 'var' == e
        ...
        function functiondef(e, t) {
          return '*' == t
            ...
            : 'variable' == e
              ...
              : '(' == e
                ? cont(pushcontext, pushlex(')'), commasep(funarg, ')'), poplex, mayberettype, statement, popcontext)
                : c && '<' == t
        ...
        function classNameAfter(e, t) {
          return '<' == t
            ...
            : 'extends' == t || 'implements' == t || (c && ',' == e)
              ? ('implements' == t && (m.marked = 'keyword'), cont(c ? typeexpr : expression, classNameAfter))
              : '{' == e
        ...
        function classBody(e, t) {
          return 'async' == e ||
            ...
            : 'variable' == e || 'keyword' == m.style
              ? ((m.marked = 'property'), cont(c ? classfield : functiondef, classBody))
              : '[' == e
                ? cont(expression, maybetype, expect(']'), c ? classfield : functiondef, classBody)
                : '*' == t
                  ? ((m.marked = 'keyword'), cont(classBody))
                  : ';' == e
                    ? cont(classBody)
        ...
        function afterImport(e) {
          return 'string' == e ? cont() : '(' == e ? pass(expression) : pass(importSpec, maybeMoreImports, maybeFrom)
        }
        function importSpec(e, t) {
          return '{' == e
            ? contCommasep(importSpec, '}')
            : ('variable' == e && register(t), '*' == t && (m.marked = 'keyword'), cont(maybeAs))
        }
                  ...
                  (function parseJS(e, t, n, r, i) {
                    ...
                    for (
                      ...
                      if ((o.length ? o.pop() : l ? expression : statement)(n, r)) {
                        ...
                        return m.marked ? m.marked : 'variable' == n && inScope(e, r) ? 'variable-2' : t
                      }
                  })(t, n, r, i, e))
            },
            indent: function(t, r) {
              ...
              var d = l.type,
                h = s == d
              return 'vardef' == d
                ? l.indented + ('operator' == t.lastType || ',' == t.lastType ? l.info + 1 : 0)
                : 'form' == d && '{' == s
                  ? l.indented
                  : 'form' == d
                    ? l.indented + o
